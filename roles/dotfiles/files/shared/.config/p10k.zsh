# Generated by Powerlevel10k configuration wizard on 2020-11-10 at 08:25 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=64
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=61
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local   modified='%136F'  # yellow foreground
